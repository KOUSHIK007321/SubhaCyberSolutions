  ...
  return (
    <div className="flex">
      ...
      <div
        ...
        } min-h-screen bg-gray-800 text-white transition-all duration-300 ease-in-out`}
      >
        <div className="flex justify-between items-center p-4 border-b border-gray-700">
          ...
          <button
            ...
            className="text-white focus:outline-none cursor-pointer hover:bg-blue-600 rounded"
          >
          ...
          <ul>
            ...
            <li>
              <Link
                ...
                className={`flex items-center px-4 py-3 transition-colors ${
                  isActive("/Admin-Dashboard/Manage-Services")
                    ? "bg-blue-600 text-white"
                    : "hover:bg-gray-700"
                }`}
              >
